...
namespace MarsRover.Tests.Mover
{
    ...
    public class When_Moving_Left
    {
        ...
        [Test]
        [TestCase(10, 10, 'N', 3, Direction.West, 7, 10)]
        [TestCase(20, 10, 'N', 5, Direction.West, 15, 10)]
        [TestCase(5, 10, 'N', 2, Direction.West, 3, 10)]
        [TestCase(2, 0, 'N', 2, Direction.West, 0, 0)]
        [TestCase(10, 10, 'W', 3, Direction.South, 10, 7)]
        [TestCase(20, 10, 'W', 5, Direction.South, 20, 5)]
        [TestCase(5, 10, 'W', 2, Direction.South, 5, 8)]
        [TestCase(0, 2, 'W', 2, Direction.South, 0, 0)]
        [TestCase(10, 10, 'S', 3, Direction.East, 13, 10)]
        [TestCase(20, 10, 'S', 5, Direction.East, 25, 10)]
        [TestCase(5, 10, 'S', 2, Direction.East, 7, 10)]
        [TestCase(0, 2, 'S', 2, Direction.East, 2, 2)]
        [TestCase(10, 10, 'E', 3, Direction.North, 10, 13)]
        [TestCase(20, 10, 'E', 5, Direction.North, 20, 15)]
        [TestCase(5, 10, 'E', 2, Direction.North, 5, 12)]
        [TestCase(2, 0, 'E', 2, Direction.North, 2, 2)]
